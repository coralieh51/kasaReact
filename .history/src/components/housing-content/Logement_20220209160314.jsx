  ...
  if (!currentHousing) {
    ...
    return (
      ...
      <main>
        ...
        <Dropdown className="description" type="description" content={[currentHousing.description]} />
        <Dropdown className="description" type="equipements" content={currentHousing.equipments} />
      </main>
      <Footer />
      </>
    );
