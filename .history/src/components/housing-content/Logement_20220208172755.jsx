  ...
  if (!currentHousing) {
    ...
    return (
      <main>
        ...
        <HostInfos className hostname={currentHousing.host.name} hostpicture={currentHousing.host.picture} />
        <Ratings range={currentHousing.rating} />
        <Dropdown className="dropdown" type="description" content={[currentHousing.description]} />
