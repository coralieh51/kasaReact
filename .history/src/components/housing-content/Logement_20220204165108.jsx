  ...
  if (!currentHousing) {
    ...
    return (
      <main>
        ...
        <Dropdown className="dropdown" open=false type="description" content={[currentHousing.description]} />
        <Dropdown className="dropdown" open=false type="equipements" content={currentHousing.equipments} />
      </main>
    );
  }
}
